            ...
            <section className="w-full max-w-screen-lg m-auto px-4 py-8">
                ...
                <div className="bg-slate-900 rounded-b-lg">
                    ...
                    <div className="px-8 py-4 mb-2">
                        <span className="text-gray-300">Wednesday, March 20, 2024</span>
                        <h1 className="text-3xl text-purple-400 mb-2">Dora Owo</h1>
                        <p className="text-white duration-300">owo">...</span></p>
